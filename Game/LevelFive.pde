public class LevelFive extends GameLevel {
  ...
  void SetWave() {
    ...
    ant.add(new HatAnt("Ant.png", 1700, ROW5, 100, 50, 15, 1, new Hat("ConeHat.png", 1800, ROW5 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 1950, ROW1, 100, 50, 15, 1, new Hat("ConeHat.png", 1950, ROW1 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 1950, ROW2, 100, 50, 15, 1, new Hat("ConeHat.png", 1950, ROW2 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 2050, ROW3, 100, 50, 15, 1, new Hat("ConeHat.png", 1950, ROW3 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 2050, ROW4, 100, 50, 15, 1, new Hat("ConeHat.png", 1950, ROW4 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 1850, ROW5, 100, 50, 15, 1, new Hat("ConeHat.png", 1950, ROW5 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 2100, ROW1, 100, 50, 15, 1, new Hat("ConeHat.png", 2100, ROW1 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 2100, ROW2, 100, 50, 15, 1, new Hat("ConeHat.png", 2100, ROW2 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 2200, ROW3, 100, 50, 15, 1, new Hat("ConeHat.png", 2100, ROW3 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 2200, ROW4, 100, 50, 15, 1, new Hat("ConeHat.png", 2100, ROW4 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 2000, ROW5, 100, 50, 15, 1, new Hat("ConeHat.png", 2100, ROW5 - 5, 25, 25, 10)));
    ...
    ant.add(new HatAnt("Ant.png", 1750, ROW1, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW1 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1750, ROW2, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW2 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1750, ROW3, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW3 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1750, ROW4, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW4 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1750, ROW5, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW5 - 2, 25, 25, 20))); 
    ...
    ant.add(new HatAnt("Ant.png", 1450, ROW4, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW4 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1450, ROW5, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW5 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1550, ROW1, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW1 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1550, ROW2, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW2 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1550, ROW3, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW3 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1550, ROW4, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW4 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1550, ROW5, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW5 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1650, ROW1, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW1 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1650, ROW2, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW2 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1650, ROW3, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW3 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1650, ROW4, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW4 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1650, ROW5, 100, 50, 15, 1, new Hat("BucketHat.png", 2200, ROW5 - 2, 25, 25, 20))); 
    ant.add(new HatAnt("Ant.png", 1800, ROW1, 100, 50, 15, 1, new Hat("ConeHat.png", 1800, ROW1 - 5, 25, 25, 10)));
    ant.add(new HatAnt("Ant.png", 1800, ROW2, 100, 50, 15, 1, new Hat("ConeHat.png", 1800, ROW2 - 5, 25, 25, 10)));
    ...
    ant.add(new AntMound("AntMound.png", 104 + 144 * 7 + 10, ROW4 - 20, 130, 100, 20, 0));
    ant.add(new AntMound("AntMound.png", 104 + 144 * 7 + 10, ROW5 - 20, 130, 100, 20, 0));
    ant.add(new AntMound("AntMound.png", 104 + 144 * 8 + 10, ROW1 - 20, 130, 100, 20, 0));
    ant.add(new AntMound("AntMound.png", 104 + 144 * 8 + 10, ROW2 - 20, 130, 100, 20, 0));
    ant.add(new AntMound("AntMound.png", 104 + 144 * 8 + 10, ROW3 - 20, 130, 100, 20, 0));
    ant.add(new AntMound("AntMound.png", 104 + 144 * 8 + 10, ROW4 - 20, 130, 100, 20, 0));
    ant.add(new AntMound("AntMound.png", 104 + 144 * 8 + 10, ROW5 - 20, 130, 100, 20, 0));
